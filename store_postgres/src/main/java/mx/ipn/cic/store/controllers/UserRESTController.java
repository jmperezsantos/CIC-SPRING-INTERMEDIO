...
public class UserRESTController {
	...
	public ResponseEntity<UserEntity> edit(@RequestBody UserEntity user, @PathVariable(name = "id") Integer id) {
	...
	public ResponseEntity<List<UserEntity>> findByName(@PathVariable(name = "name") String name) {
